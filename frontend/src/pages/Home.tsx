  ...
  const features = [
    {
      ...
      title: "Bulk Upload",
      description:
        "Drag-and-drop multiple files or use our API for seamless batch uploads",
    },
    {
    ...
    },
    {
      ...
      description:
        "Control access, preview assets, and share securely across teams",
    },
    {
    ...
    },
    {
      ...
      description:
        "Track downloads, uploads, and asset performance with detailed insights",
    },
  ];
      ...
      <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Upload, process, organize, and distribute your images, videos, and
            documents seamlessly. Built for teams that need enterprise-grade
            asset management with intelligent automation.
          </p>
          ...
          {!isLoggedIn && (
            <div className="max-w-2xl mx-auto mb-12 bg-slate-800/50 backdrop-blur border border-purple-500/30 rounded-xl p-8">
              ...
              <p className="text-gray-300 mb-6">
                Create your account to start managing your digital assets. No
                credit card required. Set up your workspace, invite team
                members, and begin uploading assets immediately.
              </p>
              <button className="px-8 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-lg font-semibold transition inline-flex items-center group">
                Create Free Account
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Everything you need to streamline your digital asset workflow from
              upload to delivery
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              From upload to distribution - fully automated background
              processing
            </p>
          </div>
      ...
      <section id="tech" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              Built on proven technologies for scalability, reliability, and
              performance
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-12 shadow-2xl">
            ...
            <p className="text-xl text-purple-100 mb-8">
              Join teams managing millions of digital assets with intelligent
